    ...
    return (
      ...
      >
        ...
        <div className='text-center border-b pb-4 mb-2 border-dashed border-gray-300'>
          ...
          {organization?.address && <div className='text-xs mt-1'>{organization.address}</div>}
          {organization?.phoneNumber && <div className='text-xs'>{organization.phoneNumber}</div>}
          {organization?.taxId && (
        ...
        {/* Body Content */}
        <div className='mb-6 pb-2 border-b border-dashed border-gray-300'>{children}</div>
