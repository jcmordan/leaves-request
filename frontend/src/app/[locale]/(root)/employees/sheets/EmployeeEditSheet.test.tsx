...
import { EMPLOYEE_FOR_EDIT_QUERY, EMPLOYEE_EDIT_METADATA_QUERY, UPDATE_EMPLOYEE_MUTATION } from './EmployeeEditSheetQueries'
...
const mocks = [
  ...
  {
    request: {
      query: EMPLOYEE_EDIT_METADATA_QUERY,
    },
    result: {
      data: {
        ...
        departmentSections: { edges: [{ node: { id: 's-1', name: 'Frontend', departmentId: 'd-1' } }] },
