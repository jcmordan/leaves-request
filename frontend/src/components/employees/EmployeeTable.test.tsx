...
vi.mock('./EmployeeEmptyState', () => ({
  EmployeeEmptyState: () => <div data-testid="empty-state">empty</div>,
}))
...
describe('EmployeeTable', () => {
  ...
  it('renders paginated table when employees exist', () => {
    ...
    expect(screen.getByTestId('paginated-table')).toHaveTextContent('rows:3-next:true')
  })
})
