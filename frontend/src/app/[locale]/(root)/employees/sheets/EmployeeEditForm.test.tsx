...
// Mock Sections
vi.mock('./sections', () => ({
  IdentitySection: () => <div data-testid="identity-section">Identity Section</div>,
  RolePlacementSection: () => <div data-testid="role-placement-section">Role Placement Section</div>,
  TimelineHierarchySection: () => <div data-testid="timeline-hierarchy-section">Timeline Hierarchy Section</div>,
}))
...
describe('EmployeeEditFormContent', () => {
  it('renders all form sections and separators in order', () => {
    ...
    expect(screen.getByTestId('timeline-hierarchy-section')).toBeInTheDocument()
