...
vi.mock('../hooks/useDepartmentSectionSearch', () => ({ useDepartmentSectionSearch: vi.fn() }))

// Mock Components
vi.mock('@/components/forms', () => ({
  FormComboboxInput: ({ name, label }: any) => <div data-testid={`combobox-${name}`}>{label}</div>,
}))
...
describe('RolePlacementSection', () => {
  ...
  it('renders all comboboxes with correct labels', () => {
    ...
    expect(screen.getByTestId('combobox-departmentSectionId')).toBeInTheDocument()
  })
