...
public interface ILeaveRequestService
{
    ...
    Task<PaginationResult<AbsenceRequest>> GetAbsenceRequestsAsync(PaginationFilter filter);
    ...
    Task<PaginationResult<AbsenceRequest>> GetTeamAbsencesAsync(Guid managerId, PaginationFilter filter);

    /// <summary>Returns paged absence requests for a specific employee.</summary>
    Task<PaginationResult<AbsenceRequest>> GetEmployeeRequestsAsync(Guid employeeId, PaginationFilter filter);
