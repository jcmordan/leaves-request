...
type MutationArgs<TData = any, TVariables extends OperationVariables = OperationVariables> = {
...
>({
  ...
  const [mutate, { loading, error }] = useMutation<TData, TVariables>(mutation, options)
